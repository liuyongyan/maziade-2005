...
-   Do SZ and BP **share** common genetic susceptibility alleles?
-   Are there alleles **specific** to each disorder?
...
-   Liddle: look at symptom dimensions rather than disease categories
...
-   Genetic heterogeneity
    -   Similar clinical phenotypes may result from different susceptibility allele or mutations across families
-   Phenocopies
...
Step 2: Specify transmission models
Step 3: Perform linkage analysis with Mod Score approach
Step 4: Apply multiple testing correction
Step 5: Conduct heterogeneity analysis
```
...
-   Current tests may fail to detect between-family heterogeneity due to small number of families
